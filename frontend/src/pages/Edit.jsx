    ...
    function convertToBase64(e) {
      ...
      useEffect(()=>{
        try {
            ...
            let item =  res.data.cars.find(element => 
                element._id == id
              )
              setColor(item.color)
      ...
      const handleDetails = () => {
        ...
        axios.patch(`https://buycars-gksq.onrender.com/cars/update/${id}`,carObj,{
        headers: {
    ...
    return (
      ...
      <Box width="40%" m={"auto"}>
        <FormControl>
          ...
          <Input type="number"value={scratch} onChange={(e) => setScratch(e.target.value)} />
          <FormLabel>Mileage</FormLabel>
          <Input type="number" value={mileage} onChange={(e) => setMileage(e.target.value)} />
          <FormLabel>Number of accidents</FormLabel>
          <Input type="number" value={accidents} onChange={(e) => setAccidents(e.target.value)} />
          <FormLabel>original_paint</FormLabel>
          <Input type="text" value={orgPaint} onChange={(e) => setPaint(e.target.value)} />
          ...
          <Input type="text" value={registration_place} onChange={(e) => setRegPlace(e.target.value)} />
